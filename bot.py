...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "vip_trc":
        ...
        await context.bot.send_message(
            ...
            text="<b>After depositing, send the screenshot below.</b>\n\n<code>TSxvZs96scypQ2Bc67c4jqN68fdNVCJNKw</code>",
            reply_markup=InlineKeyboardMarkup(keyboard),
            parse_mode="HTML"
        )
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ Payment received. Confirmation usually under 30 minutes.", reply_markup=keyboard)
...
async def remove_vip(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in data:
        ...
        await update.message.reply_text("User not VIP.")
...
async def vip_list(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    data = load_vip_data()
    if not data:
        await update.message.reply_text("No VIPs.")
        return
